...
export const SharePresentation = ({ message, sendData, level }) => (
  <View style={styles.container}>
    <Text style={styles.text}>Вы можете отправить нам созданный вами уровень нажав на кнопку отправить</Text>
    <TouchableOpacity style={styles.button} activeOpacity={0.7} onPress={sendData}>
    ...
    <View style={styles.offer}>
      <Text style={styles.text}>
        Код, который вы видите ниже, это созданный выми уровень записанный в специальном формате. Если у вас не
        получилось отправить его кнопкой сверху, отправьте этот код разработчикам на почту:
      </Text>
      <TouchableOpacity
        style={styles.link}
